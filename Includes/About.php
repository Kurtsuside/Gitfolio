        ...
        <div class="container about-me">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white my-0">About me</h2>
                    <hr class="divider light my-4">
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <h2>I am a 17 year old Application and media -developer at the ROC ter AA Helmond.</h2>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-6">
                    <h3>My Resume</h3>
                    <a href="Includes/KurtPeeters.docx" download><i id="resume" class="far fa-file fa-7x"></i></a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <h4>06-55010270 <i class="fas fa-phone"></i></h4>
                    <h4>My Email-Adress:</h4>
